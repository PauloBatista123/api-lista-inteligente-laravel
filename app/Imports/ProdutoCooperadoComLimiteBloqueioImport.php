...
class ProdutoCooperadoComLimiteBloqueioImport implements ToCollection, WithHeadingRow, ShouldQueue, WithChunkReading, WithEvents
{
    ...
    public function collection(Collection $rows)
    {
        ...
        foreach ($rows as $key => $row)
        {
            ...
            $validations = [
                ...
                'limiteAtribuido' => $row['limiteatribuido'],
            ];
            ...
            $this->produtoService->criar(
                ...
                CooperadoComLimiteEBloqueio::class,
                $registro->id,
                $this->listaId
            );
